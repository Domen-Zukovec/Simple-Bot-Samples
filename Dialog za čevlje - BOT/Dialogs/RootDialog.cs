...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class RootDialog : ComponentDialog
    {
            ...
            : base("root")
        {
            ...
            {
                new SlotDetails("first", "text", "Kako ti je ime?"),
                new SlotDetails("last", "text", "Kako se pišeš?"),
            };

            // This defines an address dialog that collects street, city and zip properties.
            var address_slots = new List<SlotDetails>
            {
                new SlotDetails("street", "text", "Prosim vpiši svojo ulico"),
                new SlotDetails("city", "text", "Prosim vpiši mesto bivanja"),
                new SlotDetails("zip", "text", "Prosim vpiši poštno številko"),
            };
            ...
            var slots = new List<SlotDetails>
            {
                ...
                new SlotDetails("age", "number", "Prosim vpši svojo starost"),
                new SlotDetails("shoesize", "shoesize", "Vpiši svojo velikost čevljev", "Velikost čevlja mora biti med 20 in 50."),
